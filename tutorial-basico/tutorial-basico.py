            ...
            "regions": [
{
        ...
        "conditional_formats": [{"range": "A4:A9", "formula": "D4>$F$1", "style": {"bg_color": "FF4444"}}],
        "table_ranges": ["A4:F9"],
...
generar_excel_personalizado(config, "Tutorial_Basico.xlsx")

if __name__=='__main__':
    print('OK: Tutorial_Basico.xlsx')
