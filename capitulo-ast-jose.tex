...
\begin{enumerate}
  \item \textbf{Expansi\'on de macros.}  Cada forma del DSL
    (p.\,ej.\ \texttt{def-table}, \texttt{exists},
    \texttt{conditional-rendering}) se expande en una llamada al constructor
  ...
  \item \textbf{Ejecuci\'on.}  El programa generado se ejecuta, produciendo
    el archivo \texttt{.xlsx} con los datos, f\'ormulas y reglas de formato
