% ===========================================================================
%  Capítulo 4 — El backend Excel: generación de archivos .xlsx
% ===========================================================================
\chapter{El backend Excel: generaci\'on de archivos \xlsx{}}
\label{cap:generacion}

El DSL produce un \'arbol de sintaxis abstracta independiente de cualquier
sistema de salida.  Este cap\'{\i}tulo describe el backend implementado como
demostraci\'on: la traducci\'on de ese AST a un programa Python que, mediante
la biblioteca openpyxl, construye un archivo \xlsx{} con f\'ormulas y formato
condicional persistente.  La misma arquitectura ---funci\'on gen\'erica CLOS
que despacha sobre el tipo de nodo--- puede emplearse para implementar
backends alternativos sin modificar el DSL ni el AST.
...
El principio de separaci\'on queda codificado en la arquitectura:
\file{ast-def.lisp} declara \emph{qu\'e existe},
\file{dsl-directo.lisp} declara \emph{c\'omo se escribe},
y \file{generate-code-direct.lisp} declara \emph{a qu\'e se traduce en
este backend}.  Un backend alternativo reemplazar\'{\i}a \'unicamente los
dos \'ultimos archivos sin tocar el AST ni el DSL.
