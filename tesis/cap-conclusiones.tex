...
un lenguaje de dominio espec\'{\i}fico en Common Lisp para la generaci\'on
declarativa de hojas de c\'alculo de planificaci\'on, y se valid\'o sobre
...
\begin{enumerate}
  ...
  \item \textbf{La separaci\'on entre intenci\'on e implementaci\'on es
    alcanzable con un DSL interno en Lisp.}  El sistema permite declarar
    tablas relacionadas, columnas calculadas, cuantificadores existenciales
    y reglas de coloreado condicional sin escribir ninguna letra de columna
    Excel, ninguna cadena de f\'ormula ni ninguna llamada a la API de destino.
    El backend es el \'unico punto del c\'odigo donde viven esos detalles.
  ...
  \item \textbf{El sistema genera archivos \xlsx{} con formato condicional
    activo.}  La decisi\'on de usar \texttt{FormulaRule} en lugar de coloreado
    est\'atico significa que la hoja de c\'alculo sigue siendo funcional cuando
    el usuario la edita directamente en Excel, sin necesidad de volver a
    ejecutar el DSL.
